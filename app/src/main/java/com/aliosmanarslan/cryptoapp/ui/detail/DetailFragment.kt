...
import com.aliosmanarslan.cryptoapp.databinding.FragmentDetailBinding
import com.aliosmanarslan.cryptoapp.model.detail.CoinDetail
import com.aliosmanarslan.cryptoapp.model.detail.DetailResponse
...
class DetailFragment : BaseFragment<FragmentDetailBinding,DetailViewModel>(
    ...
    private fun parseData(it: DetailResponse?) {
        ...
        coin?.let {
            with(binding){
                ivDetailImage.loadImage(it.logo)
